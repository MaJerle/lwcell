...
This file shall be named ``gsm_config.h`` and its default template looks like the one below:

.. tip::
    Check :ref:`api_gsm_config` section for possible configuration settings
