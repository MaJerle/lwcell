...
* Implementing :cpp:func:`lwgsm_ll_init` and :cpp:func:`lwgsm_ll_deinit` callback functions
...
.. note::
    Check :ref:`api_lwgsm_input` for more information about direct & indirect input processing.
...
.. note::
    Check :ref:`api_lwgsm_sys` for function prototypes.
...
* It uses separate thread for received data processing.
  It uses :cpp:func:`lwgsm_input_process` or :cpp:func:`lwgsm_input` functions, based on application configuration of :c:macro:`GSM_CFG_INPUT_USE_PROCESS` parameter.
  ...
  * When :c:macro:`GSM_CFG_INPUT_USE_PROCESS` is enabled, :cpp:func:`lwgsm_input_process` is used,
...
.. literalinclude:: ../../lwgsm/src/include/system/port/win32/lwgsm_sys_port.h
    :language: c
    :linenos:
    :caption: Actual header implementation of system functions for WIN32

.. literalinclude:: ../../lwgsm/src/system/lwgsm_sys_win32.c
    :language: c
    :linenos:
...
.. literalinclude:: ../../lwgsm/src/include/system/port/cmsis_os/lwgsm_sys_port.h
    :language: c
    :linenos:
    :caption: Actual header implementation of system functions for CMSIS-OS based operating systems

.. literalinclude:: ../../lwgsm/src/system/lwgsm_sys_cmsis_os.c
    :language: c
    :linenos:
